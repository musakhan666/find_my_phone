...
class HomeViewModel @Inject constructor(
    ...
    private val _textFieldValue =
        mutableStateOf(serviceStatusManager.getKeywordForVoiceRecognition())
    ...
    private val _isAlarmActivated = MutableLiveData(false)
    val isAlarmActivated: LiveData<Boolean> get() = _isAlarmActivated
