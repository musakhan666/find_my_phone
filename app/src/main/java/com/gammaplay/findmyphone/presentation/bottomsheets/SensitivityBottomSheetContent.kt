...
@Composable
fun SensitivityBottomSheetContent(
    sensitivityLevels: List<Int>,  // List of sensitivity levels as string resource IDs
    ...
    // Keep track of the selected sensitivity level
    var selectedLevel by remember { mutableStateOf(selectedMode) }
    ...
    Column(
        ...
        // Title
        Text(
            text = stringResource(id = R.string.choose_sensitivity),
            fontSize = 18.sp,
