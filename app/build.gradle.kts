...
dependencies {
    ...
    implementation ("org.jetbrains.kotlinx:kotlinx-coroutines-android:1.7.3") // Adjust version as needed
    implementation ("androidx.localbroadcastmanager:localbroadcastmanager:1.1.0")

    implementation(libs.androidx.ui)
    implementation ("androidx.lifecycle:lifecycle-viewmodel-compose:2.6.1") // or the latest version
